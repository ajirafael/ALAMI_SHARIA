...
WebUI.click(findTestObject('Object Repository/Page_Mail 7 - Dashboard/td_Assalamualaikum                                                    alami'))

WebUI.switchToWindowTitle('Mail 7 - Dashboard')

WebUI.click(findTestObject('Object Repository/Page_Mail 7 - Dashboard/a_Klik Untuk Aktivasi Email  Log-in (1)'))
